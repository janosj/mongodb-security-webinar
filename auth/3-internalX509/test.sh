...
mongod --fork --replSet "rs0" --port 27017 --dbpath $RS_BASE/data1 --logpath $RS_BASE/data1/mongodb.log --keyFile $RS_BASE/keyfile
echo "Launching Mongo2 on port 27018..."
mongod --fork --replSet "rs0" --port 27018 --dbpath $RS_BASE/data2 --logpath $RS_BASE/data2/mongodb.log --keyFile $RS_BASE/keyfile
echo "Launching Mongo3 on port 27019..."
mongod --fork --replSet "rs0" --port 27019 --dbpath $RS_BASE/data3 --logpath $RS_BASE/data3/mongodb.log --keyFile $RS_BASE/keyfile
